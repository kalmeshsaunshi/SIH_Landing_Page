...
const LandingPage = () => {
  return (
   <div > {/* 1cm padding around the body */}
      {/* Header */}
      <header className="bg-white text-black py-6 px-8 shadow-md"> {/* Added padding to navbar */}
      ...
      <div className="min-h-screen bg-white text-gray-800 p-[27.8px]">
      {/* Hero Section */}
  ...
  <div className="container mx-auto px-6 py-8 bg-white rounded-lg shadow-lg">
    ...
    <div className="space-y-12">
      ...
      <div className="flex flex-col lg:flex-row items-center gap-4 lg:gap-8 p-8 bg-gray-200 shadow-lg rounded-lg mb-8 mx-auto max-w-4xl">
        <div className="lg:w-1/2">
          <img
            src="/assets/ai-powered-neutrality.jpg"
            alt="AI-Powered Neutrality Pathways"
            className="rounded-lg shadow-lg max-h-80 object-cover"
          />
        </div>
        <div className="lg:w-1/2 text-gray-700 space-y-4">
          <h3 className="text-2xl font-semibold text-gray-800">
            AI-Powered Neutrality Pathways
          </h3>
          <p>
            Leverage AI to simulate various carbon neutrality strategies, including afforestation
      ...
      {/* Feature 4 */}
      <div className="flex flex-col lg:flex-row items-center gap-4 lg:gap-8 p-8 bg-gray-200 shadow-lg rounded-lg mb-8 mx-auto max-w-4xl">        <div className="lg:w-1/2">
          <img
            src="/assets/carbon-credits-estimation.jpg"
            alt="Carbon Credits Estimation"
            className="rounded-lg shadow-lg max-h-80 object-cover"
          />
        </div>
        <div className="lg:w-1/2 text-gray-700 space-y-4">
          ...
          <p>
            Calculate potential carbon credits earned by reducing emissions or adopting cleaner technologies.
  ...
  <div className="container mx-auto px-6">
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div>
        ...
        <p>
          CoalMine is committed to providing innovative solutions to help the coal mining industry
          quantify its carbon footprint and pursue carbon neutrality. We offer tools to track emissions,
          estimate carbon sinks, and simulate neutrality pathways.
        </p>
      </div>
      ...
      <div>
        ...
        <p className="mb-4">Email: <a href="mailto:support@coalmine.com" className="hover:text-gray-400">support@coalmine.com</a></p>
        <p>Phone: +1 234 567 890</p>

        <div className="mt-6">
          <h3 className="text-xl font-bold mb-4">Follow Us</h3>
          <div className="flex space-x-4">
            <a href="https://facebook.com" target="_blank" rel="noreferrer noopener" className="hover:text-gray-400">
            ...
            <a href="https://twitter.com" target="_blank" rel="noreferrer noopener" className="hover:text-gray-400">
              <svg className="h-6 w-6" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <a href="https://linkedin.com" target="_blank" rel="noreferrer noopener" className="hover:text-gray-400">
              <svg className="h-6 w-6" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    ...
    <div className="mt-8 text-center text-sm text-gray-400">
      <p>&copy; 2024 CoalMine. All Rights Reserved.</p>
      <p>
